			...
			get
			{
				return
				  (_CACHE_U.GetOrAdd(
					...
					rgbBytes =>
					  _FullClamp(
						(127500000 + _GetRed(rgbBytes) * 500000 - _GetGreen(rgbBytes) * 418688 - _GetBlue(rgbBytes) * 081312) /
						1000000)));
			}
		}
			...
			get
			{
				return
				  (_CACHE_V.GetOrAdd(
					...
					rgbBytes =>
					  _FullClamp(
						(127500000 - _GetRed(rgbBytes) * 168736 - _GetGreen(rgbBytes) * 331264 + _GetBlue(rgbBytes) * 500000) /
						1000000)));
			}
		}
