...
namespace FilterWrapper.Filters
{
	class FilterLQ : IImageFilter
	{
		...
		public string Info { get { return "LQ implemented by Hawkynt"; } }

		public string Name { get { return "LQ"; } }

		public FilterImage Execute(FilterImage input)
		{
			cImage cimage = input.tocImage();
			cimage = cimage.ApplyLQ(scale.Value, complex.GetSelected());
